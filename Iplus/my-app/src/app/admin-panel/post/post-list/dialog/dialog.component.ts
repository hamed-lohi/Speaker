...
import { PostService } from "src/app/admin-panel/post/post.service";
...
export class DialogComponent implements OnInit {
    ...
    getSelectOptions(): void {
        ...
        this.service.getSelectOptions("ConstApi", "pId=200")
            .subscribe(d => this.selectListPostTypes = d);
    }
