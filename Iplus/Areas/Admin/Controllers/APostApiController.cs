...
namespace Iplus.Areas.Admin.Controllers
{
    ...
    //[Authorize]
    public class APostApiController : BaseApiController
    {

        public APostApiController()//IPostService iPostService
        {
        ...
        //public IEnumerable<dynamic> GetPostsForIndexPage()
        //{
        //    var temp = unitOfWork.PostRepository.GetPostsForIndexPage(loginUserId);
        //    return temp;
        //}
